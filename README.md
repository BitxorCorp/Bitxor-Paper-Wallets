# Bitxor Paper Wallets

Bitxor paper wallet generator
...
`npm install bitxor-paper-wallets --save`

And install plugin dependencies:

`npm install bitxor-sdk bitxor-hd-wallets --save`
...
```javascript
import { BitxorPaperWallet } from 'bitxor-paper-wallet';
...
const paperWallet = new BitxorPaperWallet(hdRootAccount, [privateKeyAccount], NetworkType.TEST_NET, '57F7DA205008026C776CB6AED843393F04CD458E0AA2D9F1D5F31A402072B2D6')
