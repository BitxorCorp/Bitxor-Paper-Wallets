...
const bitxor_qr_library_1 = require("bitxor-qr-library");
 ...
 */
const DEFAULT_GENERATION_HASH_SEED = "3A07B2E9016784D099F3D7581178D2E3A4C15D46A3998F58DAD141431B87F79A";
/**
 * Printing constants
 */
...
class BitxorPaperWallet {
    ...
    writeMnemonicPage(pdfDoc, font) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const plainMnemonicQR = new bitxor_qr_library_1.MnemonicQR(this.hdAccount.mnemonic, this.network, this.generationHashSeed);
            yield this.writePrivateQR(plainMnemonicQR, pdfDoc, page);
            const contactQR = new bitxor_qr_library_1.ContactQR("Root account", this.hdAccount.rootAccountPublicKey, this.network, this.generationHashSeed);
    ...
    writeAccountPage(account, pdfDoc) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const accountQR = new bitxor_qr_library_1.AccountQR(account.privateKey, this.network, this.generationHashSeed);
            yield this.writePrivateQR(accountQR, newPdfDoc, accountPage);
            const contactQR = new bitxor_qr_library_1.ContactQR(account.name, account.publicKey, this.network, this.generationHashSeed);
